...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " CRUIZE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " CRUIZE" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " CRUIZE");
    }
