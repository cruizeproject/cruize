...
bool CWallet::EncryptWallet(const SecureString& strWalletPassphrase)
{
...

    {
        ...
        SetMinVersion(FEATURE_WALLECRUIZEYPT, pwalletdbEncryption, true);
...
// cruize: total coins staked (non-spendable until maturity)
...
// cruize: check 'spent' consistency between wallet and txindex
// cruize: fix wallet spent state according to txindex
...
// cruize: disable transaction (only for coinstake)
